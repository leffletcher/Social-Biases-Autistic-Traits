...
var instructions_post_AQ = {
	type: 'instructions',
	pages: ['Thank you for your answers. Please click "next" below to save your data; there may be a short delay before the experiment progresses to the final pages, which will redirect you back to Prolific. Please do not close the page during this delay.'],
	show_clickable_nav: true,
    button_label_next: 'Next'
};
...
//attention check for the bias_assignment
...
var attention_bias = {
	...
	timeline: [
		...
		on_start: function(trial) {
			trial.data = {correct_answer:'1', task:'attention_bias'};
		},
		on_finish: function(data) {
			if(data.response == 1) {
				data.correct = true;
		...
		on_start: function(trial) {
			...
			if (last_trial_correct) {
				...
				trial.stimulus = 'Correct! We wish to trade with the <b>orange aliens</b>, as they have important resources and are on our side.';
				trial.button_html[1] = correct_button_html;
				...
				var correct_button_html = '<button class="jspsych-btn disabled"><img src=%choice% style="border: 5px solid; border-color: green; width:300px;height:300px"></button>';
				trial.stimulus = 'That is not correct; we wish to trade with the <b>orange aliens</b>, as they have important resources and are on our side.';
				trial.button_html[0] = wrong_button_html;
				trial.button_html[1] = correct_button_html;
...
condition_assignment = 'FOR_CASE_fixed_word_order';
...
jsPsych.init({
    timeline: [consent_form, loop_autism_timeline, preload, instructions_FOR_CASE_ORANGE, noun_production_loop, loop_notif, attention_bias, instructions_sentence_exp, sentence_exposure_redundant, instructions_sentence_comp, sentence_comprehension_redundant, instructions_sentence_prod, sentence_production_redundant, instructions_post_debrief, aq_10, post_language_questions, post_language_questions_multi_choice, instructions_post_AQ, save_data, end_card],
		//on_finish: function() {
